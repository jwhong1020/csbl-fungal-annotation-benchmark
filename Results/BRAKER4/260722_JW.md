...
| ---------- | ---------------- | -----------: | ---------------: | -----------------: | -------------------: | --------: | -------: |
| CPH        | g12231.t1        |         63.0 |              297 |               96.9 |                 98.0 | 2.55e-123 |      353 |
| H3H        | g181.t1          |         61.9 |              452 |               99.1 |                 99.0 | 6.07e-176 |      496 |
| HispS      | g238.t1          |         75.0 |              925 |               54.1 |                 98.9 |       0.0 |     1305 |
| Luz        | g180.t2          |         84.5 |              232 |               86.5 |                 93.9 | 2.03e-146 |      409 |

CPH, H3H, HispS and Luz homolog candidates were identified in the BRAKER4-predicted proteome. CPH, H3H, and Luz showed high sequence identity with high sequence coverage. However, the HispS candidate showed high identity and nearly complete subject coverage, but only 54.1% of query coverage.

### Genomic location of candidate bioluminescence genes

The genomic coordinates of the best-hit candidates were identified from the BRAKER4 GFF3 annotation.

| Gene | BRAKER4 candidate | Scaffold | Start | End | Strand |
|---|---|---|---:|---:|:---:|
| Luz | g180.t2 | Scaffold1 | 584,558 | 586,695 | − |
| H3H | g181.t1 | Scaffold1 | 587,045 | 589,054 | + |
| HispS | g238.t1 | Scaffold1 | 726,699 | 730,085 | − |
| CPH | g12231.t1 | Scaffold6 | 1,813,231 | 1,815,002 | − |  

- The `luz` and `h3h` candidates are directly adjacent on Scaffold1.
- The intergenic distance between `luz` and `h3h` is approximately 349 bp.
- The two genes are located on opposite strands.
- The `hisps` candidate is located on the same scaffold, approximately 138 kb downstream of `h3h`.
- The `cph` candidate is located separately on Scaffold6.
